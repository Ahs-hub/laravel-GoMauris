...
@section('content')
    ...
    <div class="container py-4">
        ...
        <div class="title-section">
            ...
            <h1 class="main-title section-heading">Ile aux Cerfs Catamaran Trip w/Lunch BBQ / Drinks </h1>
            ...
            <div class="col-lg-4">
                <div class="booking-card">
                    <div class="mb-3">
                        ...
                        <div class="price" >€55 <small class="text-muted" style="font-size: 1.25rem; font-weight: 600;">without transfer</small></div>
                        <div class="price" >€90 <small class="text-muted" style="font-size: 1.25rem; font-weight: 600;">with transfer</small></div>
