...
@section('content')
    ...
    <div class="container py-4">
        ...
        <div class="title-section">
            <div class="subtitle paragraph-text">A shared sightseeing on the North Coast</div>
            <h1 class="main-title section-heading">North Coast Sightseeing</h1>
        ...
        <div class="row mb-4">
            <div class="col-12">
                <div class="tour-gallery">
                    <div class="row g-2">
                        <div class="col-8">
                            <img src="{{ asset('images/tours/north-coast-sightseeing/north-coast-sightseeing-1.jpg') }}" alt="north coast" class="main-image">
                        </div>
                        <div class="col-4">
                            <div class="gallery-grid">
                                <div class="gallery-item">
                                <img src="{{ asset('images/tours/north-coast-sightseeing/north-coast-sightseeing-2.jpg') }}" alt="north coast">
                                </div>
                                <div class="gallery-item">
                                <img src="{{ asset('images/tours/north-coast-sightseeing/north-coast-sightseeing-3.jpg') }}" alt="north coast">
                                </div>
                                <div class="gallery-item">
                                <img src="{{ asset('images/tours/north-coast-sightseeing/north-coast-sightseeing-4.jpg') }}" alt="north coast">
                                </div>
                                <div class="gallery-item">
                                <img src="{{ asset('images/tours/north-coast-sightseeing/north-coast-sightseeing-5.jpg') }}" alt="north coast">
                    ...
                    <div class="swiper-container" id="gallerySwiper">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <img src="{{ asset('images/tours/north-coast-sightseeing/north-coast-sightseeing-1.jpg') }}" alt="Sunset Cruise">
       
                            </div>
                            <div class="swiper-slide">
                                <img src="{{ asset('images/tours/north-coast-sightseeing/north-coast-sightseeing-2.jpg') }}" alt="Tropical Beach">

                            </div>
                            <div class="swiper-slide">
                                <img src="{{ asset('images/tours/north-coast-sightseeing/north-coast-sightseeing-3.jpg') }}" alt="Island Adventure">
                            </div>
                            <div class="swiper-slide">
                                <img src="{{ asset('images/tours/north-coast-sightseeing/north-coast-sightseeing-4.jpg') }}" alt="Local Culture">
                            </div>
                            <div class="swiper-slide">
                                <img src="{{ asset('images/tours/north-coast-sightseeing/north-coast-sightseeing-5.jpg') }}" alt="Snorkeling">
                            </div>
                        </div>
